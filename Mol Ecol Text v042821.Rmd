...
This is shared *by-nc-sa/4.0*, I'm not writing it to be some polished final thing but something that shifts through new ideas and new people using or modifying parts of it. 
...
knitr::include_graphics('/Users/johnwares/Dropbox/MolEcolText/MEImages/IMG_1549.jpeg')
```
...
we will read Prunier et al 2013 Optimizing the trade-off between spatial and genetic sampling efforts in patchy populations: towards a better assessment of functional connectivity using an individual-based sampling scheme ***Molecular Ecology doi: 10.1111/mec.12499*** what do you think - can we think of why there are advantages to lean towards one type of sampling or another for a particular project?
...
```{r, out.width='90%', fig.align='center', fig.cap='...',echo=FALSE}
knitr::include_graphics('/Users/johnwares/Dropbox/MolEcolText/MEImages/amnatlangurgillespie.jpg')
```
...
shinyAppFile("/Users/johnwares/Dropbox/MolEcolText/shiny_popgen-master/Quant-Gen/additive_alleles_app.R",options=list(width="90%",height=500))
...
#9 kinship, parentage (Hill humbers, discrimination and assignment)
#  more behavior and interaction eg voles and mating, diversity and disease
...
# 10. data never fail to surprise.
