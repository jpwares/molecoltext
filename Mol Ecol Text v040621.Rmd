...
we will read Prunier et al 2013 Optimizing the trade-off between spatial and genetic sampling efforts in patchy populations: towards a better assessment of functional connectivity using an individual-based sampling scheme ***Molecular Ecology doi: 10.1111/mec.12499***
...
```{r, out.width='90%', fig.align='center', fig.cap='...',echo=FALSE}
knitr::include_graphics('/Users/johnwares/Dropbox/MolEcolText/MEImages/normalpdf.jpg')
```
...
```{r, out.width='90%', fig.align='center', fig.cap='...',echo=FALSE}
knitr::include_graphics('/Users/johnwares/Dropbox/MolEcolText/MEImages/humpback.jpg')
```
...
```{r, out.width='90%', fig.align='center', fig.cap='...',echo=FALSE}
knitr::include_graphics('/Users/johnwares/Dropbox/MolEcolText/MEImages/roots.jpg')
```
...
```{r, out.width='90%', fig.align='center', fig.cap='...',echo=FALSE}
knitr::include_graphics('/Users/johnwares/Dropbox/MolEcolText/MEImages/blurryEwersWares.jpg')
```
...
```{r, out.width='90%', fig.align='center', fig.cap='...',echo=FALSE}
knitr::include_graphics('/Users/johnwares/Dropbox/MolEcolText/MEImages/robinson.jpg')
```
**Fig.7-4, from Robinson et al. 2013**

## 7.4 even more complex?

the fancy places Hickerson has gone to estimate co-divergence and more NOte you dealt w EDWARDS AND BEERLI EARLIER, skyline plots and more, mixed hierarchical/IBD models and more, but really we will get into such things in chapter 9 so this is the wrap-up on ch7
...
Still working on all proper citations but already have much thanks to Silas Tittes for Shiny apps, to Justin Bagley and many others for help with R code checking, to my entire lab group in 2019-2021 for their patience, to my entire Molecular Ecology class in 2020 for *their* patience, to Natalia Bayona-Vasquez and Todd Pierson for their assistance getting me worked towards the experiential mode of teachign this class, 
# dangling notes
