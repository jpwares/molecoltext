...
1. Replace the default paired frequencies 0.1, 0.9 with your single starting allele *A* frequency.
...
Now you have basically the same drift simulation as before, but it is also calculating the Fst between the simulated populations for you. If the number of populations is MORE than 2, assume an *island model* of movement in these simulations. 
