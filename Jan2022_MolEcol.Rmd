...
(Before you go any further, be sure to have the accompanying excel file downloaded)
...
Run the simulation using these parameters:* N of 100, allele freq of 0.05, gneerations 100, bottleneck time 100, bottleneck pop size 100.*

Now look at your resulting graph. Did any of the replicates reach fixation (look at the top of the graph)?

Open up the excel file to the first sheet labeled “Experiment One”
...
Open up the excel file to the “Experiment Two” Sheet. 

Enter the values you obtain by running the simulation into the sheet. 
