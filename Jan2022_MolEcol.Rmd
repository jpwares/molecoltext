...
Test it out by clicking 'GO'. You'll see that it is a simple simulation based on the values you give it.
...
Email this short report to Dr. Wares or submit it via eLC *before you read further*. 
